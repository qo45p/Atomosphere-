...
def convertWeather(temp):
	datas = csv.DictReader(open("weather.csv", encoding="utf-8"))
	for data in datas:
		if temp in data['Weather']:
			return "/static/images/weather-icon/"+data['Picture']+".png"

#"{% static "images/weather-icon/sunny.png" %}"
